...
describe('compact configuration and defaults', () => {
  ...
  it('validates common values and pressure-policy invariants', () => {
    const bad = [
      ...
      [{ retainRatio: 0.97 }, /retainRatio \(0.97\) must be less than the resolved thresholdRatio \(0.95\)/],
      ...
      [
        { modelPolicies: [{ provider: MODEL, model: MODEL, retainRatio: 0.97 }] },
        /modelPolicies\[0\]: retainRatio \(0.97\).*thresholdRatio \(0.95\)/,
      ],
