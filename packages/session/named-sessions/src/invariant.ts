/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-named-sessions`.
 * @module @deepseek-ai/dsh-named-sessions/invariant
 */
...
const PACKAGE_NAME = '@deepseek-ai/dsh-named-sessions'

/** Cordis companion plugin name. */
export const name = 'named-sessions-invariant'
 ...
 * named-run derivation must hold its per-name lock at that moment. Consumers
 * acquire the lock before agent creation/resumption and release it after the
 * run settles, so a lock-less announcement means a named id reached the
 * registry without passing through {@link ./index.ts} acquisition.
