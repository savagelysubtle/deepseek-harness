...
export const zh = {
  ...
  'message.context.mail.senderWithClass': '{sender}（{class}）',
  'message.context.mail.class.seat': '席位',
  'message.context.mail.class.unverified': '未验证',
  'message.context.mail.blocking': '对方正在等待回复',
  'message.context.mail.refusal.title': '邮件被拒绝',
  'message.context.mail.refusal.to': '收件人：{to}',
  'message.context.mail.refusal.reason': '原因：{reason}',
  ...
  'message.turnStopped.stopped': '已停止',
  'message.turnStopped.user.hint': '你手动停止了本轮。',
  'message.turnStopped.system.hint': '本轮被系统自动取消（例如父会话结束或权限钩子拒绝）。',
  'message.turnStopped.crash': '已中断',
  'message.turnStopped.crash.hint': '此前的运行意外中断（例如进程崩溃）；会话重新加载后自动补全了这条记录，崩溃前的内容均完整保留。',
...
export const en = {
  ...
  'message.context.mail.senderWithClass': '{sender} ({class})',
  'message.context.mail.class.seat': 'seat',
  'message.context.mail.class.unverified': 'unverified',
  'message.context.mail.blocking': 'Correspondent is waiting',
  'message.context.mail.refusal.title': 'Mail refused',
  'message.context.mail.refusal.to': 'to {to}',
  'message.context.mail.refusal.reason': 'Reason: {reason}',
  ...
  'message.turnStopped.stopped': 'Stopped',
  'message.turnStopped.user.hint': 'You stopped this turn.',
  'message.turnStopped.system.hint': 'This turn was cancelled automatically (for example, by a parent session ending or a permission hook).',
  'message.turnStopped.crash': 'Interrupted',
  'message.turnStopped.crash.hint': 'The run was interrupted unexpectedly (for example, a crash); this record was completed automatically after the session reloaded. Everything before the crash is preserved.',
