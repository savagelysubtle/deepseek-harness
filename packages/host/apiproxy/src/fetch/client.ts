...
export interface IApiClient {
  ...
  /** Publish one message into a served mailbox address and wake its target. */
  mailbox: {
...
export abstract class AbstractApiClient implements IApiClient {
  ...
  protected mintRpcId(): RpcId {
    ...
    // designed plain-HTTP LAN deployment is neither. getRandomValues carries no
    // such gate, so mint from it in every carrier environment.
